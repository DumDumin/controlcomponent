...
namespace ControlComponents.Core
{
    internal static class ControlComponentReflection
    {
        ...
        public static TReturn CallMethodGeneric<TParam1, TParam2, TParam3, TParam4, TReturn>(string targetRole, string methodName, TParam1 param1, TParam2 param2, TParam3 param3, TParam4 param4, IControlComponent instance)
        {
            Type type = instance.GetType();
            MethodInfo method = type.GetMethods().Where(m => m.Name == methodName && m.GetParameters().Length == 4 && m.ReturnType != typeof(void)).First();
            MethodInfo generic = method.MakeGenericMethod(typeof(TParam3), typeof(TParam4), typeof(TReturn));
            return (TReturn)generic.Invoke(instance, new object[] { param1, param2, param3, param4 });
        }
